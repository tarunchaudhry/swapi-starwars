  ...
  <div className="w-full bg-black py-2 px-4 text-gray-700 antialiased">
    ...
    <div className="mx-auto max-w-screen-xl">
      <div className="border-b border-gray-300">
        <div className=" m-auto max-w-screen-md pt-16 pb-8" data-testid="logo">
          <svg viewBox="0 0 1347.6 227.4">
            <g>
              <path
        ...
        <div>
          ...
          >
            <li className="mr-6 mb-4" data-testid="links">
              <Link href="/">
                <a className="border-none text-yellow-600 hover:text-yellow-700">
                  Home
                </a>
              </Link>
            </li>
